      ...
      {data && (
        <div id={props.id} className="classContainer">
          ...
          <div className="logo-container">
            <img
              className="classLogo"
              src={"../images/classLogos/" + data.name + ".png"}
              alt="class logo"
              type="image/png"
            />
          </div>
          <p className="border">
            ...
            {data.hit_die.toString()}
          </p>
          <div className="jumpTarget border" id="proficiency">
          ...
          <div className="border">
            <strong>{data.name} is proficient with: </strong>
            {data.proficiencies.map((pro) => {
              return <div>{pro.name}</div>;
            })}
          </div>
          ...
          <div className="jumpTarget border" id="subclasses">
